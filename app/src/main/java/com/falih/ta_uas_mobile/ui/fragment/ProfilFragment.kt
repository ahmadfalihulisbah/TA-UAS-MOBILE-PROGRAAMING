package com.falih.ta_uas_mobile.ui.fragment
...
import com.falih.ta_uas_mobile.R
import com.falih.ta_uas_mobile.model.DataItemModel
import com.falih.ta_uas_mobile.rest.ApiService
import com.falih.ta_uas_mobile.rest.RetroConfig
        ...
        apiService.getProfil()
            ...
            .subscribe({
                ...
                for (i: Int in items.indices) {
                    ...
                    if (BuildConfig.NPM.equals("16670089")) {

                        activity?.let { it1 ->
                            Glide.with(it1).load("https://scontent-sin2-1.xx.fbcdn.net/v/t1.0-9/37412566_1428194947326575_5288656435750633472_n.jpg?_nc_cat=107&_nc_ht=scontent-sin2-1.xx&oh=1f85e0f29f105c6e9b57ff6da7b1f1f6&oe=5DB87130")
                                .override(512, 512).error(R.drawable.error_image).into(ivImageProfile)
                        }
                    }
                }
